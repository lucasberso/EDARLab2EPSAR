...
// @grant        none
// @downloadURL  https://github.com/lucasberso/EDARLab2EPSAR/raw/refs/heads/main/ParteEfluenteEPSAR.user.js
// @updateURL    https://github.com/lucasberso/EDARLab2EPSAR/raw/refs/heads/main/ParteEfluenteEPSAR.user.js
...
(function() {
    ...
    const FACTOR_SATURACION = (diaDelMes >= 1 && diaDelMes <= 4) ? 1.50 : 1.0;
    ...
    const EXCEL_COLUMNS = { NNH4: 26, NNO2: 28, NNO3: 30 , NT: 20, PT: 23};
    ...
    function registrarParteExistenteYContinuar() {
        ...
        // window.location.href = "https://aplica.epsar.gva.es/depuradoras/Partes/AnalisisEfluente.aspx?res=E";
    ...
    function crearBotonLanzador() {
        ...
        botonLanzador.innerText = "Análisis en Efluente - EDARLab➔EPSAR";
    ...
    function despertarUI(listaEdars) {
        ...
        uiContenedor.innerHTML = `
            <div style="background:linear-gradient(135deg,${STYLE.PRIMARIO},${STYLE.SECUNDARIO}); padding:14px 16px; display:flex; justify-content:space-between; align-items:center; border-top-left-radius:16px; border-top-right-radius:16px;">
                <span style="color:white; font-size:14px; font-weight:700;">Selector de partes - Análisis en Efluente</span>
    ...
    function iniciarSecuenciaPersistente() {
        ...
        console.log(`[EDARLab➔EPSAR] Lanzando ejecución de ${tareas.length} partes de análisis en efluente.`);
        ...
        const headerTxt = `==================================================\nREPORTE DE VOLCADO EFLUENTE EDARLab➔EPSAR (v${versionScript})\nFecha: ${fechaHoy}\n==================================================\n\n`;
    ...
    function descargarReporteTxtFinal() {
        ...
        enlacelink.download = `Reporte_AnalisisEfluente_EPSAR_${fecha}_${horaClean}.txt`;
    ...
    function limpiarYResetearTodoAZero() {
        ...
        if (botonExistente) {
            botonExistente.innerText = "Análisis en Efluente - EDARLab➔EPSAR";
